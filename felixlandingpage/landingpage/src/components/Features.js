...
const Features = () => {
  return (
    <>
      <div id="feature" className="h-fit sm:mt-10 sm:flex sm:justify-center pb-28 sm:items-center sm:gap-x-5">
        <div className="grid place-items-center">
          <Image src={"/feature-img.png"} width={400} height={400} />
        </div>
        <div className="mt-36 sm:mt-10 sm:flex sm:flex-col sm:justify-around">
          <h1 className="font-bold text-xl text-center sm:text-3xl">Accomplish More,Every Day.</h1>
          <div className="mt-28 sm:mt-14 px-10">
